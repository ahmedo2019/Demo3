...
public class compgraphics extends Application {
    ...
    public  Parent createContent() {
		...
		for(int i = 0; i < grid.length; i++) {
			...
			for (int i = 0; i < tiles.size(); i++) {
				...
				tile.setTranslateX((600 / numRows) * (i % numRows));				// will create the tile into a certianw width
				tile.setTranslateY((600/ numCols) * (i / numCols));				// will create the tile into a certain length
    ...
    public class Tile extends StackPane {
        ...
        public Tile(String value) {
            ...
            text.setFont(Font.font(30));									// font of the value that will be shown
    	...
    	public int screenHeight() {
	        ...
	        int tileHeight = (screenHeight / 2) - 370;		// makes it so the height fits in the javafx 
		...
		public void click(int x, int y) throws AWTException{	// the auto click bot
			...
			bot.delay(500);
			bot.mousePress(InputEvent.BUTTON1_MASK);	// will press left click on these
			bot.mouseRelease(InputEvent.BUTTON1_MASK);	// will release left click on this x and y
		}
